  ...
  <div ref="modalRoot" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
      <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <button type="button" @click="$emit('before-close')"
        ...
        <div class="flex justify-center items-center space-x-4">
          ...
          <button @click="deleteBand" type="button"
...
<script setup lang="ts">
  ...
  async function deleteBand() {
    ...
    await bandsStore.removeBand(props.band.id);
    await bandsStore.removeAuthorizedDevice(props.band.deviceId);
    emit("before-close");
  }
</script>